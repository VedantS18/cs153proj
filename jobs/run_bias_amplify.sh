...
#SBATCH --mem=32G
#SBATCH --time=2:00:00
#SBATCH --output=cs153_amp_%j.out
...
# Amplify bias: add contrast direction (subtract=False) for bias concepts.
# Shows the OTHER direction of bidirectional control — model becomes MORE stereotyped.
# Same alphas and layers as the debiasing sweep so results are directly comparable.
